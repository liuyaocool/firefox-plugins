...
// document.getElementById('ly-postman-toggle').addEventListener('click', togglePanel);

function togglePanel(e) {
    var aa = document.getElementById(postmanId);
    if (aa) {
...
console.log('ly postman injected');
